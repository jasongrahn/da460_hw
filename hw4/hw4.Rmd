...
The shape of the sample distribution appears highly normal, though it appears to have a bit of a right skew. The median is `r mean_of_sample_means150$median` with a standard deviation of `r mean_of_sample_means150$sd` This larger sampling provides a point estimate of `r mean_of_sample_means150`. 
